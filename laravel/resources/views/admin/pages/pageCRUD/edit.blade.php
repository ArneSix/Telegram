            ...
            <div class="col">
                <form action="{{ route('dashboard.page.update', $page->id) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$page->title}}" class="form-control" id="title" placeholder="Place title here" name="title">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="intro" rows="3" name="intro">
                            {{$page->intro}}
                        </textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$page->layout}}" class="form-control" id="layout" placeholder="enter layout here" name="layout">
                    </div>
